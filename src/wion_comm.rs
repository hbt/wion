...
//    let mut head: Header = Default::default();
    let mut head: Header = get_default_header();
    head.cmdSpecificData = DataSection::Segment(Set_status_data_section::default());
...
fn get_default_header() -> Header {
    ...
    if (name == "light") {
        head.model = [0x45, 0x43, 0x4f, 0x2d, 0x37, 0x38, 0x30, 0x32, 0x31, 0x30, 0x38, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
    } else if (name == "ac" || name == "eco") {
        head.model = [0x45, 0x43, 0x4f, 0x2d, 0x37, 0x38, 0x30, 0x38, 0x32, 0x37, 0x36, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
    }
    return head
}

...
fn send_basic_modify(socket: &UdpSocket, write_value:u8, device_ip: &SocketAddr ) {
    ...
    head.cmd_type = 0x02;
    // ac
//    head.model = [0x45, 0x43, 0x4f, 0x2d, 0x37, 0x38, 0x30, 0x38, 0x32, 0x37, 0x36, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]; // TODO(hbt) replace by env var
    // light
    head.model = [0x45, 0x43, 0x4f, 0x2d, 0x37, 0x38, 0x30, 0x32, 0x31, 0x30, 0x38, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]; // TODO(hbt) replace by env var
